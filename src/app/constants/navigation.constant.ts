...
export const NAV_FOOTER: NavFooterItem[] = [
  {
    ...
    icon: 'ph ph-gear',
    path: '/Settings',
    roles: [...SEMUA_OPERASIONAL, Role.Warehouse],
  },
  {
    label: 'nav__activity',
    icon: 'ph ph-pulse',
