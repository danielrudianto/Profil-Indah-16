...
@Component({
    selector: 'app-type-purchase-chart',
    templateUrl: './type-purchase-chart.component.html',
    styleUrls: ['./type-purchase-chart.component.scss'],
...
export class TypePurchaseChartComponent {
  constructor(
